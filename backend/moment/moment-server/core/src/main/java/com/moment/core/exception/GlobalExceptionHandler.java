...
import com.moment.core.common.ErrorResponse;
import com.moment.core.common.code.ErrorCode;
...
public class GlobalExceptionHandler {
    ...
    /*
    * [Exception] 이미 존재하는 ID일때
    *
     */
    @ExceptionHandler(UserAlreadyExistException.class)
    protected ResponseEntity<ErrorResponse> UserAlreadyExistExceptionHandler(UserAlreadyExistException ex) {
        log.error("UserAlreadyExistException", ex);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.USER_ALREADY_EXIST, ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }

    /*
    * [Exception] 존재하지 않는 유저
     */
    @ExceptionHandler(UserNotFoundException.class)
    protected ResponseEntity<ErrorResponse> UserNotFoundExceptionHandler(UserNotFoundException ex) {
        log.error("UserNotFoundException", ex);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.USER_NOT_FOUND, ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }

    /*
    * [Exception] 이미 등록된 여행일
     */
    @ExceptionHandler(AlreadyBookedDateException.class)
    protected ResponseEntity<ErrorResponse> AlreadyBookedDateExceptionHandler(AlreadyBookedDateException ex) {
        log.error("AlreadyBookedDateException", ex);
