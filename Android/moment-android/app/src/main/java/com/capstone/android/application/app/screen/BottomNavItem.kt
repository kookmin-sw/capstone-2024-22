...
sealed class BottomNavItem(
    ...
    object Receipt : BottomNavItem(title = 1 , screenRoute = "Receipt",label = "여행 티켓",selectedDrawableId = R.drawable.ic_nav_receipt_black, unselectedDrawableId = R.drawable.ic_nav_receipt_grey)
