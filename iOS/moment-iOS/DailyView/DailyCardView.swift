...
//                            ForEach(dailyViewModel.DailyItems) { dailyItems in
//                                // 각 cardItem에 대한 AccordionView 인스턴스를 생성
//                                AccordionDailyView( audioRecorderManager: audioRecorderManager, isEditing: $isEditing, selectedCardIDs: $selectedCardIDs,cardViewModel: cardViewModel,  cardDailyItem : dailyItems)
//                                
//                            }
//                        }
//                        //첫번째 주석 넣기
...
//                    yesAction: {
//                        // 삭제 로직
//                        dailyViewModel.DailyItems.removeAll { selectedCardIDs.contains($0.id) }
...
//    @ObservedObject var cardViewModel: CardViewModel
//    var cardDailyItem: CardItemDaily
//    
//    var body: some View {
...
//                Button(action: {
//                    // 체크박스 선택/해제 로직
//                    if selectedCardIDs.contains(cardDailyItem.id) {
//                        selectedCardIDs.remove(cardDailyItem.id)
//                    } else {
//                        selectedCardIDs.insert(cardDailyItem.id)
//                    }
//                }) {
//                    Image(systemName: selectedCardIDs.contains(cardDailyItem.id) ? "checkmark.square.fill" : "square")
...
//                    contentVStack
//                } label: {
//                    HeaderDailyView(isExpanded: $isExpanded, cardDailyItem: cardDailyItem)
//                }
//                .accentColor(.black)
//                
...
//            locationAndTimeInfo
//            DynamicGradientRectangleDailyView(audioRecorderManager: audioRecorderManager, longText: "\(cardDailyItem.exampleText)")
...
//        HStack {
//            Image("CardTime")
//            Text(cardDailyItem.date).font(.pretendardMedium11)
//            Spacer()
//            CustomCarbarDivider()
//            Text(cardDailyItem.time).font(.pretendardMedium11)
//        }
//    }
//}
//
...
//                    
//                }
//                Text("\(cardDailyItem.time)") // 타이틀 예시
//                    .foregroundColor(.black)
//                    .font(.pretendardExtrabold14)
//                Spacer()
//                
//                Text("\(cardDailyItem.id)")
//                    .font(.pretendardExtrabold14)
//                    .foregroundColor(.black)
//            }
